 ...
 */
public class BandDataItem extends Item {
    public static final String NAMESPACE = null;
    public static final String ELEMENT = "item";
    public static final String ITEM_ID_PREFIX = "_BandData";

    public static final String TRANSDUCER_DATA_ID = "occthermcomf_bosch";
    public static final String TRANSDUCER_DATA_TYPE = "TCS";
    public static final String TRANSDUCER_DATA_CLASS = "BandData";

    private String username;
    private Timestamp timestamp;

    public BandDataItem(String username, Timestamp timestamp) {
    ...
    public String toXML() {
        ...
        builder.append("<" + ELEMENT + " id=\"" + ITEM_ID_PREFIX + "\">");
